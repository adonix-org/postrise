...
Get connected *FAST* with **Postrise**, a thread-safe library for Java developers to acquire JDBC connections from PostgreSQL servers. Postrise provides a simple, object-oriented solution to configuring data sources and encourages secure access. The event-based architecture enables subscriptions to data source lifecycles.
